...
abstract public class CConnection extends CMsgHandler {
	...
	public void setServerName(String name_) {
		serverName = name_;
	}
	
	public void setServerPort(int port_) {
		serverPort = port_;
	}
	...
	boolean isSecure() {
		return csecurity != null ? csecurity.isSecure() : false;
	}
	...
	protected void setState(stateEnum s) {
		state_ = s;
	}
	
	protected void setReader(CMsgReader r) {
		reader_ = r;
	}
	
	protected void setWriter(CMsgWriter w) {
		writer_ = w;
	}
