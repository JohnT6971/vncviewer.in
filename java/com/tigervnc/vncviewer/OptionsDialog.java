...
class OptionsDialog extends Dialog {
	...
	private static final Map <Object, String> callbacks = new HashMap <Object, String>();
	/* Compression */
	...
	private void storeOptions() {
		...
		try {
			for(Map.Entry <Object, String> iter : callbacks.entrySet()) {
				...
				Method cb = obj.getClass().getMethod(iter.getValue());
				if(cb == null)
	...
	private void handleJpeg() {
		jpegInput.setEnabled(jpegCheckbox.isSelected() &&
