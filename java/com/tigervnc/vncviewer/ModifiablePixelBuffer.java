...
public abstract class ModifiablePixelBuffer extends PixelBuffer {
	...
	//   specified Rect.
	public abstract WritableRaster getBufferRW(org.w3c.dom.css.Rect r);
	...
	//   getBufferRW().
	public abstract void commitBufferRW(org.w3c.dom.css.Rect r);
	...
	// Fill a rectangle
	public void fillRect(org.w3c.dom.css.Rect r, byte[] pix) {
		WritableRaster buf;
		int w, h;
	...
	public void imageRect(org.w3c.dom.css.Rect r, byte[] pixels) {
	...
	public void copyRect(org.w3c.dom.css.Rect rect, java.awt.Point move_by_delta) {
		Raster srcData;
		WritableRaster dstData;
		
		org.w3c.dom.css.Rect drect, srect;
		
		drect = new org.w3c.dom.css.Rect(rect.tl, rect.br);
	...
	public void maskRect(org.w3c.dom.css.Rect r, Object pixels, byte[] mask_) {
		org.w3c.dom.css.Rect cr = getRect().intersect(r);
		...
		java.awt.Point offset = new java.awt.Point(cr.tl.x - r.tl.x, cr.tl.y - r.tl.y);
	...
	public void maskRect(org.w3c.dom.css.Rect r, int pixel, byte[] mask) {
		// FIXME
	}
	...
	public void fillRect(PixelFormat pf, org.w3c.dom.css.Rect dest, byte[] pix) {
	...
	public void imageRect(PixelFormat pf, org.w3c.dom.css.Rect dest, byte[] pixels) {
		WritableRaster dstBuffer = getBufferRW(dest);
	...
	public void imageRect(PixelFormat pf, org.w3c.dom.css.Rect dest, Raster pixels) {
		WritableRaster dstBuffer = getBufferRW(dest);
